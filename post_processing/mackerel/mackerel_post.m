...
%  %   sub_centerline_first;
%  %   clear h nslt

    Ux_osc = 0.0512; Uy_osc = 0.0166;
    ux     = U_0 - Ux_osc;      
    uy     = Uy_osc;
    U      = sqrt(ux^2 + uy^2);
...
%     clear pnt_tail vel_tail frc_tail
%     clear sts_tail


%     save body_data pnt_body_t
%     save tail_data pnt_tail_t
...
%     clear sts_temp
%     clear sts_temp_f
    %sub_animation_force_distribution;
%     clear sts_int_fine 
...
%     clear fy_res_distri_fine_f
%     clear fy_rea_distri_fine_f
%     clear fy_cfd_distri_fine_f
    clear fy_EBT
